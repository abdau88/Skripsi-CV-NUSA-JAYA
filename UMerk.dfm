object FMerk: TFMerk
  ...
  object AdsMerk: TADODataSet
    ...
    CursorType = ctStatic
    AfterInsert = AdsMerkAfterInsert
    AfterEdit = AdsMerkAfterEdit
    BeforePost = AdsMerkBeforePost
    AfterPost = AdsMerkAfterPost
    BeforeDelete = AdsMerkBeforeDelete
    AfterDelete = AdsMerkAfterDelete
    CommandText = 'select * from Merk'
    Parameters = <>
    Left = 416
    Top = 24
    object AdsMerkkd_merk: TWideStringField
      DisplayWidth = 13
      FieldName = 'kd_merk'
      Size = 6
    end
    object AdsMerknama_merk: TWideStringField
      DisplayWidth = 24
      FieldName = 'nama_merk'
    end
  end
  ...
  object AdsBarang: TADODataSet
    ...
    Connection = FMenu.ADOConnection1
    CursorType = ctStatic
    BeforeDelete = AdsMerkAfterDelete
