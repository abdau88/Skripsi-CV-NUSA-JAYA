object FUser: TFUser
  ...
  object GroupBox1: TGroupBox
    ...
    object DBEdtPass: TDBEdit
      ...
      PasswordChar = '*'
      TabOrder = 10
      OnClick = DBEdtPassClick
      OnKeyDown = DBEdtPassKeyDown
    end
  end
  ...
  object AdsUser: TADODataSet
    ...
    CursorType = ctStatic
    AfterInsert = AdsUserAfterInsert
    AfterEdit = AdsUserAfterEdit
    BeforePost = AdsUserBeforePost
    AfterPost = AdsUserAfterPost
    BeforeDelete = AdsUserBeforeDelete
    AfterDelete = AdsUserAfterDelete
  ...
  object AdsBantuan: TADODataSet
    ...
    Left = 120
    Top = 8
    object AdsBantuanuser: TWideStringField
      FieldName = 'user'
      Size = 10
    end
    object AdsBantuanpassword: TWideStringField
      FieldName = 'password'
      Size = 10
    end
    object AdsBantuanmenu1: TWideStringField
      FieldName = 'menu1'
      Size = 1
    end
    object AdsBantuanmenu2: TWideStringField
      FieldName = 'menu2'
      Size = 1
    end
    object AdsBantuanmenu3: TWideStringField
      FieldName = 'menu3'
      Size = 1
    end
    object AdsBantuanmenu4: TWideStringField
      FieldName = 'menu4'
      Size = 1
    end
    object AdsBantuanmenu5: TWideStringField
      FieldName = 'menu5'
      Size = 1
    end
    object AdsBantuanmenu6: TWideStringField
      FieldName = 'menu6'
      Size = 1
    end
    object AdsBantuanmenu7: TWideStringField
      FieldName = 'menu7'
      Size = 1
    end
    object AdsBantuanmenu8: TWideStringField
      FieldName = 'menu8'
      Size = 1
    end
    object AdsBantuanmenu9: TWideStringField
      FieldName = 'menu9'
      Size = 1
    end
  end
