object FTransaksiJual: TFTransaksiJual
  Left = 253
  Top = 138
  Width = 1060
  Height = 530
    ...
    object TabSheet2: TTabSheet
      ...
      object QRNota: TQuickRep
        ...
        object DetailBand1: TQRBand
          ...
          BandType = rbDetail
          object qrdbjumlahbeli: TQRDBText
            Left = 124
            Top = 15
            Width = 41
            Height = 8
  ...
  object AdsTransJual: TADODataSet
    ...
    CursorType = ctStatic
    AfterInsert = AdsTransJualAfterInsert
    BeforePost = AdsTransJualBeforePost
    AfterPost = AdsTransJualAfterPost
    CommandText = 'select * from Penjualan'
    Parameters = <>
    Left = 310
    Top = 248
    object AdsTransJualno_faktur: TWideStringField
      FieldName = 'no_faktur'
      Size = 6
    end
    object AdsTransJualtgl_faktur: TDateTimeField
      FieldName = 'tgl_faktur'
    end
    object AdsTransJualkd_karyawan: TWideStringField
      FieldName = 'kd_karyawan'
      LookupDataSet = FMenu.AdsLogIn
      LookupKeyFields = 'user'
      Size = 6
    end
    object AdsTransJualtotal_harga: TBCDField
      FieldName = 'total_harga'
      Precision = 19
    end
    object AdsTransJualjumlah_uang: TBCDField
      FieldName = 'jumlah_uang'
      Precision = 19
    end
    object AdsTransJualkembali: TBCDField
      FieldName = 'kembali'
      Precision = 19
    end
  end
  ...
  object AdsKaryawan: TADODataSet
    ...
    Connection = FMenu.ADOConnection1
    CursorType = ctStatic
    CommandText = 'select user from t_User'
    Parameters = <>
    Left = 404
    Top = 251
  end
  ...
  object AdsDetJual: TADODataSet
    Active = True
    Connection = FMenu.ADOConnection1
    CursorType = ctStatic
    AfterInsert = AdsDetJualAfterInsert
    BeforePost = AdsDetJualBeforePost
    AfterPost = AdsDetJualAfterPost
    CommandText = 'select * from DetailPenjualan'
    DataSource = dsTransJual
    IndexFieldNames = 'no_faktur'
    MasterFields = 'no_faktur'
    Parameters = <>
    Left = 372
    Top = 315
    object AdsDetJualno_item: TIntegerField
      DisplayWidth = 12
      FieldName = 'no_item'
    end
    object AdsDetJualno_faktur: TWideStringField
      DisplayWidth = 9
      FieldName = 'no_faktur'
      Size = 6
    end
    object AdsDetJualkd_barang: TWideStringField
      DisplayWidth = 10
      FieldName = 'kd_barang'
      Size = 6
    end
    object AdsDetJualjumlah_item: TIntegerField
      DisplayWidth = 12
      FieldName = 'jumlah_item'
    end
    object AdsDetJualjumlah_harga: TBCDField
      DisplayWidth = 24
      FieldName = 'jumlah_harga'
      Precision = 19
    end
    object AdsDetJualharga: TStringField
      DisplayWidth = 24
      FieldKind = fkLookup
      FieldName = 'harga'
    ...
    object AdsDetJualbarang: TStringField
      FieldKind = fkLookup
      FieldName = 'barang'
      LookupDataSet = AdsBarang
      LookupKeyFields = 'kd_barang'
    ...
    object AdsDetJualstok: TStringField
      FieldKind = fkLookup
      FieldName = 'stok'
      LookupDataSet = AdsStok
      LookupKeyFields = 'kd_barang'
      LookupResultField = 'StokAkhir'
      KeyFields = 'kd_barang'
      Lookup = True
    end
  end
  ...
  object AdsStok: TADODataSet
    ...
    Left = 276
    Top = 315
    object AdsStokkd_barang: TWideStringField
      FieldName = 'kd_barang'
      Size = 6
    end
    object AdsStoknama_barang: TWideStringField
      FieldName = 'nama_barang'
    end
    object AdsStoknama_merk: TWideStringField
      FieldName = 'nama_merk'
    end
    object AdsStoknama_satuan: TWideStringField
      FieldName = 'nama_satuan'
      Size = 6
    end
    object AdsStokBeli: TFloatField
      FieldName = 'Beli'
      ReadOnly = True
    end
    object AdsStokJual: TFloatField
      FieldName = 'Jual'
      ReadOnly = True
    end
    object AdsStokStokAkhir: TFloatField
      FieldName = 'StokAkhir'
      ReadOnly = True
    end
    object AdsStokharga_jual: TBCDField
      FieldName = 'harga_jual'
      Precision = 19
    end
  end
  ...
  object ADSUser: TADODataSet
    ...
    Left = 468
    Top = 257
    object ADSUseruser: TWideStringField
      FieldName = 'user'
      Size = 10
    end
    object ADSUserpassword: TWideStringField
      FieldName = 'password'
      Size = 10
    end
    object ADSUsermenu1: TWideStringField
      FieldName = 'menu1'
      Size = 1
    end
    object ADSUsermenu2: TWideStringField
      FieldName = 'menu2'
      Size = 1
    end
    object ADSUsermenu3: TWideStringField
      FieldName = 'menu3'
      Size = 1
    end
    object ADSUsermenu4: TWideStringField
      FieldName = 'menu4'
      Size = 1
    end
    object ADSUsermenu5: TWideStringField
      FieldName = 'menu5'
      Size = 1
    end
    object ADSUsermenu6: TWideStringField
      FieldName = 'menu6'
      Size = 1
    end
    object ADSUsermenu7: TWideStringField
      FieldName = 'menu7'
      Size = 1
    end
    object ADSUsermenu8: TWideStringField
      FieldName = 'menu8'
      Size = 1
    end
    object ADSUsermenu9: TWideStringField
      FieldName = 'menu9'
      Size = 1
    end
  end
